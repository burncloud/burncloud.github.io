...
slug: /http-api/billing-usage/get-api-v1-usage
hide_table_of_contents: true
---

# GET /api/v1/usage

**树路径：** `BurnCloud → HTTP / API → Billing / Usage → GET /api/v1/usage`

> **中文解释：** 复用 Data Plane usage_handler：按 token holder 聚合月度总用量。
>
