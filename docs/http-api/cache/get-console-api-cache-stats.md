---
title: "GET /console/api/cache/stats"
slug: /http-api/cache/get-console-api-cache-stats
...
```http
GET /console/api/cache/stats HTTP/1.1
...
| 4 | `crates/server/src/api/cache.rs` | `stats()` | 读取 CacheService stats | READ Redis/cache state |
| 5 | `crates/service/crates/cache/src/service.rs` | `CacheService::*` | Redis-backed cache implementation | READ/WRITE Redis |
| 6 | `crates/server/src/api/response.rs` | `err(), ok()` | 由 stats() 直接调用 | CALL / runtime-specific |
