...
| 5 | `crates/service/crates/router-log/src/lib.rs` | `RouterLogService::get_usage_by_user()` | User usage service | READ logs |
| 6 | `crates/database/crates/router/src/log.rs` | `RouterLogModel::get_usage_by_user()` | SUM prompt/completion tokens | READ router_logs |
