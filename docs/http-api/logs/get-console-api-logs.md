---
title: "GET /console/api/logs"
slug: /http-api/logs/get-console-api-logs
hide_table_of_contents: true
---

# GET /console/api/logs

**树路径：** `BurnCloud → HTTP / API → Logs → GET /console/api/logs`

> **中文解释：** 按 page/page_size 计算 offset，分页返回 RouterLog。 核心调用：RouterLogService::get。
>
...
| 5 | `crates/service/crates/router-log/src/lib.rs` | `RouterLogService::get()` | Router log service | READ logs |
| 6 | `crates/database/crates/router/src/log.rs` | `RouterLogModel::get()` | 分页 SQL 和 row mapping | READ router_logs |
