...
| 5 | `crates/service/crates/token/src/lib.rs` | `TokenService::delete()` | Token business service | SERVICE |
| 6 | `crates/database/crates/router/src/token.rs` | `RouterTokenModel::delete()` | Router token persistence | READ/WRITE router_tokens |
