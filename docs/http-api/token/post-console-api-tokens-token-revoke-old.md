...
| 5 | `crates/service/crates/token/src/lib.rs` | `TokenService::revoke_old_key()` | Token business service | SERVICE |
| 6 | `crates/database/crates/router/src/token.rs` | `RouterTokenModel::revoke_old_key()` | Router token persistence | READ/WRITE router_tokens |
