...
| 5 | `crates/service/crates/token/src/lib.rs` | `TokenService::list()` | Token business service | SERVICE |
| 6 | `crates/database/crates/router/src/token.rs` | `RouterTokenModel::list()` | Router token persistence | READ/WRITE router_tokens |
