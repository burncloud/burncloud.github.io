...
| 5 | `crates/service/crates/token/src/lib.rs` | `TokenService::validate()` | Token business service | SERVICE |
| 6 | `crates/database/crates/router/src/token.rs` | `RouterTokenModel::validate()` | Router token persistence | READ/WRITE router_tokens |
