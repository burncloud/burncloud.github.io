...
| 5 | `crates/service/crates/user/src/lib.rs` | `UserService::topup()` | User business logic | SERVICE |
| 6 | `crates/database/crates/user/src/lib.rs` | `UserDatabase::*` | user/role/balance/recharge persistence | READ/WRITE users |
