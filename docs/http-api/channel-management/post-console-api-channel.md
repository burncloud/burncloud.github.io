...
| 6 | `crates/service/crates/channel/src/lib.rs` | `ChannelService::create()` | Channel 业务层 | SERVICE |
| 7 | `crates/database/crates/channel/src/channel_provider.rs` | `ChannelProviderModel::create()` | Channel 持久化 CRUD | READ/WRITE channel_providers |
