...
| 6 | `crates/service/crates/channel/src/lib.rs` | `ChannelService::delete()` | Channel 业务层 | SERVICE |
| 7 | `crates/database/crates/channel/src/channel_provider.rs` | `ChannelProviderModel::delete()` | Channel 持久化 CRUD | READ/WRITE channel_providers |
