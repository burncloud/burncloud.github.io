...
| 4 | `crates/database/crates/router/src/router_video_task.rs` | `RouterVideoTaskModel::get_by_task_id()` | task_id → original channel mapping | READ router_video_tasks |
| 5 | `crates/database/crates/channel/src/channel_provider.rs` | `ChannelProviderModel::get_by_id()` | load original channel base_url/key | READ channel_providers |
