---
title: "POST /v1/models/{model}:countTokens"
slug: /http-api/ai-api-data-plane/post-v1-models-model-counttokens
hide_table_of_contents: true
---

# POST /v1/models/&#123;model&#125;:countTokens

**树路径：** `BurnCloud → HTTP / API → AI API / Data Plane → POST /v1/models/{model}:countTokens`

> **中文解释：** Gemini v1 countTokens；进入原生 passthrough。
>
...
```http
POST /v1/models/gemini-example:countTokens HTTP/1.1
