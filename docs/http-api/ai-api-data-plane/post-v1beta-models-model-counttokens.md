---
title: "POST /v1beta/models/{model}:countTokens"
slug: /http-api/ai-api-data-plane/post-v1beta-models-model-counttokens
hide_table_of_contents: true
---

# POST /v1beta/models/&#123;model&#125;:countTokens

**树路径：** `BurnCloud → HTTP / API → AI API / Data Plane → POST /v1beta/models/{model}:countTokens`

> **中文解释：** Gemini v1beta countTokens；走 Gemini 原生 passthrough 规则。
>
...
```http
POST /v1beta/models/gemini-example:countTokens HTTP/1.1
