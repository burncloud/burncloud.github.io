---
title: "GET /preview/home"
slug: /http-api/web-ui-liveview-websocket/get-preview-home
hide_table_of_contents: true
---

# GET /preview/home

**树路径：** `BurnCloud → HTTP / API → Web UI / LiveView / WebSocket → GET /preview/home`
