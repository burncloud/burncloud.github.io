---
title: "GET /forgot-password"
slug: /http-api/web-ui-liveview-websocket/get-forgot-password
hide_table_of_contents: true
---

# GET /forgot-password

**树路径：** `BurnCloud → HTTP / API → Web UI / LiveView / WebSocket → GET /forgot-password`
