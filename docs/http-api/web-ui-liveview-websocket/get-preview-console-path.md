---
title: "GET /preview/console/{*path}"
slug: /http-api/web-ui-liveview-websocket/get-preview-console-path
hide_table_of_contents: true
---

# GET /preview/console/&#123;*path&#125;

**树路径：** `BurnCloud → HTTP / API → Web UI / LiveView / WebSocket → GET /preview/console/{*path}`
...
```http
GET /preview/console/dashboard HTTP/1.1
