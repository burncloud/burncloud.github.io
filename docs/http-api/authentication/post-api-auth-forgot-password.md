...
| 3 | `crates/server/src/api/auth.rs` | `forgot_password()` | Auth DTO / Handler / response policy | REQUEST/RESPONSE |
| 4 | `crates/service/crates/user/src/lib.rs` | `UserService::request_password_reset` | password/JWT/OAuth/user business logic | SERVICE |
