---
title: "GET /console/api/monitor/security/circuit-breaker-status"
slug: /http-api/monitoring-security/get-console-api-monitor-security-circuit-breaker-status
hide_table_of_contents: true
---

# GET /console/api/monitor/security/circuit-breaker-status

**树路径：** `BurnCloud → HTTP / API → Monitoring / Security → GET /console/api/monitor/security/circuit-breaker-status`

> **中文解释：** 通过 localhost 调用 /console/internal/health 获取 circuit breaker 状态。 核心调用：call_router_internal。
>
...
```http
GET /console/api/monitor/security/circuit-breaker-status HTTP/1.1
...
| 4 | `crates/server/src/api/security.rs` |
