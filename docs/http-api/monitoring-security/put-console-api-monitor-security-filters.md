---
title: "PUT /console/api/monitor/security/filters"
slug: /http-api/monitoring-security/put-console-api-monitor-security-filters
hide_table_of_contents: true
---

# PUT /console/api/monitor/security/filters

**树路径：** `BurnCloud → HTTP / API → Monitoring / Security → PUT /console/api/monitor/security/filters`

> **中文解释：** 序列化 FilterConfig，INSERT OR REPLACE 到 sys_settings。 核心调用：Database::execute_query_with_params。
>
...
```http
PUT /console/api/monitor/security/filters HTTP/1.1
...
| 5 | `crates/database/src/lib.rs` | `Database::query_with_params() / execute_query_with_params()` | 数据库抽象执行 settings SQL | READ/WRITE sys_settings |
