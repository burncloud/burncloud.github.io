---
title: "GET /console/api/monitor/security/filters"
slug: /http-api/monitoring-security/get-console-api-monitor-security-filters
hide_table_of_contents: true
---

# GET /console/api/monitor/security/filters

**树路径：** `BurnCloud → HTTP / API → Monitoring / Security → GET /console/api/monitor/security/filters`

> **中文解释：** 读取 sys_settings.security_filters；没有记录或 JSON 无效时使用默认配置。 核心调用：Database::query_with_params。
>
...
```http
GET /console/api/monitor/security/filters HTTP/1.1
