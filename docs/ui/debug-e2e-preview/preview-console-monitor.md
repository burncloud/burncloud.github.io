---
title: "/preview/console/monitor"
slug: /ui/debug-e2e-preview/preview-console-monitor
hide_table_of_contents: true
---

# /preview/console/monitor

**树路径：** `BurnCloud → UI-only Actions → Debug / e2e-preview → /preview/console/monitor`
...
```text
navigate_to=/preview/console/monitor
authenticated=true
locale=zh-CN
theme=system
```
