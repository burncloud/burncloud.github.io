---
title: "/preview/console/dashboard"
slug: /ui/debug-e2e-preview/preview-console-dashboard
hide_table_of_contents: true
---

# /preview/console/dashboard

**树路径：** `BurnCloud → UI-only Actions → Debug / e2e-preview → /preview/console/dashboard`
...
```text
navigate_to=/preview/console/dashboard
authenticated=true
locale=zh-CN
theme=system
```
