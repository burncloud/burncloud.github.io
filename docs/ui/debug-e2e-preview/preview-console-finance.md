---
title: "/preview/console/finance"
slug: /ui/debug-e2e-preview/preview-console-finance
hide_table_of_contents: true
---

# /preview/console/finance

**树路径：** `BurnCloud → UI-only Actions → Debug / e2e-preview → /preview/console/finance`
...
```text
navigate_to=/preview/console/finance
authenticated=true
locale=zh-CN
theme=system
```
