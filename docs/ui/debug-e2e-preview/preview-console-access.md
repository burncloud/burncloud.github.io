---
title: "/preview/console/access"
slug: /ui/debug-e2e-preview/preview-console-access
hide_table_of_contents: true
---

# /preview/console/access

**树路径：** `BurnCloud → UI-only Actions → Debug / e2e-preview → /preview/console/access`
...
```text
navigate_to=/preview/console/access
authenticated=true
locale=zh-CN
theme=system
```
