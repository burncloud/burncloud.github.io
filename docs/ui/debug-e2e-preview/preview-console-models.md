---
title: "/preview/console/models"
slug: /ui/debug-e2e-preview/preview-console-models
hide_table_of_contents: true
---

# /preview/console/models

**树路径：** `BurnCloud → UI-only Actions → Debug / e2e-preview → /preview/console/models`
...
```text
navigate_to=/preview/console/models
authenticated=true
locale=zh-CN
theme=system
```
