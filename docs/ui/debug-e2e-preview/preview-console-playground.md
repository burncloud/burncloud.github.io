---
title: "/preview/console/playground"
slug: /ui/debug-e2e-preview/preview-console-playground
hide_table_of_contents: true
---

# /preview/console/playground

**树路径：** `BurnCloud → UI-only Actions → Debug / e2e-preview → /preview/console/playground`
...
```text
navigate_to=/preview/console/playground
authenticated=true
locale=zh-CN
theme=system
```
...
| 4 | `crates/client/crates/client-shared/src/components/toast.rs` | `use_init_toast()` | 由 App() 直接调用 | CALL / runtime-specific |
| 5 | `crates/client/crates/client-shared/src/auth_context.rs` | `use_init_auth()` | 由 App() 直接调用 | CALL / runtime-specific |
| 6 | `crates/client/crates/client-shared/src/theme_context.rs` | `ThemeContext::use_init_theme()` | 由 App() 直接调用 | CALL / runtime-specific |
