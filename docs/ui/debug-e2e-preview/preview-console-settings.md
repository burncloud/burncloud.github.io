---
title: "/preview/console/settings"
slug: /ui/debug-e2e-preview/preview-console-settings
hide_table_of_contents: true
---

# /preview/console/settings

**树路径：** `BurnCloud → UI-only Actions → Debug / e2e-preview → /preview/console/settings`
...
```text
navigate_to=/preview/console/settings
authenticated=true
locale=zh-CN
theme=system
```
