...
slug: /ui/console/console-dashboard
hide_table_of_contents: true
---

# /console/dashboard

**树路径：** `BurnCloud → UI-only Actions → Console → /console/dashboard`
...
| 4 | `crates/client/src/pages/dashboard.rs` | `Dashboard re-export` | Route enum 选择的页面模块/重导出 | UI component |
| 5 | `crates/client/crates/client-dashboard/src/lib.rs` | `Dashboard` | 实际页面组件 crate | UI component/effects |
