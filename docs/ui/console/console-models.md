...
| 4 | `crates/client/src/pages/models.rs` | `ChannelPage re-export` | Route enum 选择的页面模块/重导出 | UI component |
| 5 | `crates/client/crates/client-models/src/lib.rs` | `ChannelPage` | 实际页面组件 crate | UI component/effects |
