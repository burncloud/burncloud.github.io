...
| 4 | `crates/client/src/pages/monitor.rs` | `ServiceMonitor re-export` | Route enum 选择的页面模块/重导出 | UI component |
| 5 | `crates/client/crates/client-monitor/src/lib.rs` | `ServiceMonitor` | 实际页面组件 crate | UI component/effects |
