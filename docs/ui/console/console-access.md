...
slug: /ui/console/console-access
hide_table_of_contents: true
---

# /console/access

**树路径：** `BurnCloud → UI-only Actions → Console → /console/access`
...
| 4 | `crates/client/src/pages/api.rs` | `page component / re-export` | Dioxus Route selected page module | UI component |
| 5 | `crates/client/crates/client-access/src/lib.rs` | `page/service component implementation` | Feature-specific client crate reached from page wrapper | UI effects/state |
