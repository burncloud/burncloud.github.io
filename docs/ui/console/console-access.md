...
| 4 | `crates/client/src/pages/api.rs` | `AccessPage re-export` | Route enum 选择的页面模块/重导出 | UI component |
| 5 | `crates/client/crates/client-access/src/lib.rs` | `AccessPage` | 实际页面组件 crate | UI component/effects |
