...
slug: /ui/console/console-finance
hide_table_of_contents: true
---

# /console/finance

**树路径：** `BurnCloud → UI-only Actions → Console → /console/finance`
...
| 4 | `crates/client/src/pages/billing.rs` | `page component / re-export` | Dioxus Route selected page module | UI component |
| 5 | `crates/client/crates/client-finance/src/lib.rs` | `page/service component implementation` | Feature-specific client crate reached from page wrapper | UI effects/state |
