...
| 4 | `crates/client/src/pages/billing.rs` | `FinancePage re-export` | Route enum 选择的页面模块/重导出 | UI component |
| 5 | `crates/client/crates/client-finance/src/lib.rs` | `FinancePage` | 实际页面组件 crate | UI component/effects |
