...
| 4 | `crates/client/src/pages/playground.rs` | `PlaygroundPage re-export` | Route enum 选择的页面模块/重导出 | UI component |
| 5 | `crates/client/crates/client-playground/src/lib.rs` | `PlaygroundPage` | 实际页面组件 crate | UI component/effects |
