...
slug: /ui/console/console-playground
hide_table_of_contents: true
---

# /console/playground

**树路径：** `BurnCloud → UI-only Actions → Console → /console/playground`
...
```text
navigate_to=/console/playground
authenticated=true
locale=zh-CN
theme=system
```
...
| 4 | `crates/client/src/pages/playground.rs` | `page component / re-export` | Dioxus Route selected page module | UI component |
| 5 | `crates/client/crates/client-playground/src/lib.rs` | `page/service component implementation` | Feature-specific client crate reached from page wrapper | UI effects/state |
