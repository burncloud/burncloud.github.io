---
title: "/console/logs"
slug: /ui/console/console-logs
hide_table_of_contents: true
---

# /console/logs

**树路径：** `BurnCloud → UI-only Actions → Console → /console/logs`
...
| 4 | `crates/client/src/pages/logs.rs` | `page component / re-export` | Dioxus Route selected page module | UI component |
| 5 | `crates/client/crates/client-log/src/lib.rs` | `page/service component implementation` | Feature-specific client crate reached from page wrapper | UI effects/state |
