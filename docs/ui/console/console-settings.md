...
| 4 | `crates/client/src/pages/settings.rs` | `SystemSettings re-export` | Route enum 选择的页面模块/重导出 | UI component |
| 5 | `crates/client/crates/client-settings/src/lib.rs` | `SystemSettings` | 实际页面组件 crate | UI component/effects |
