...
slug: /ui/console/console-settings
hide_table_of_contents: true
---

# /console/settings

**树路径：** `BurnCloud → UI-only Actions → Console → /console/settings`
...
| 4 | `crates/client/src/pages/settings.rs` | `page component / re-export` | Dioxus Route selected page module | UI component |
| 5 | `crates/client/crates/client-settings/src/lib.rs` | `page/service component implementation` | Feature-specific client crate reached from page wrapper | UI effects/state |
