---
title: "/console/users"
slug: /ui/console/console-users
hide_table_of_contents: true
---

# /console/users

**树路径：** `BurnCloud → UI-only Actions → Console → /console/users`
...
| 4 | `crates/client/src/pages/user.rs` | `page component / re-export` | Dioxus Route selected page module | UI component |
| 5 | `crates/client/crates/client-users/src/lib.rs` | `page/service component implementation` | Feature-specific client crate reached from page wrapper | UI effects/state |
