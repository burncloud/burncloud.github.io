...
| 4 | `crates/client/src/pages/connect.rs` | `ConnectPage re-export` | Route enum 选择的页面模块/重导出 | UI component |
| 5 | `crates/client/crates/client-connect/src/lib.rs` | `ConnectPage` | 实际页面组件 crate | UI component/effects |
