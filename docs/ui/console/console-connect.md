...
slug: /ui/console/console-connect
hide_table_of_contents: true
---

# /console/connect

**树路径：** `BurnCloud → UI-only Actions → Console → /console/connect`
...
| 4 | `crates/client/src/pages/connect.rs` | `page component / re-export` | Dioxus Route selected page module | UI component |
| 5 | `crates/client/crates/client-connect/src/lib.rs` | `page/service component implementation` | Feature-specific client crate reached from page wrapper | UI effects/state |
