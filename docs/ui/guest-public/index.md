---
title: "/"
slug: /ui/guest-public/index
hide_table_of_contents: true
---

# /

**树路径：** `BurnCloud → UI-only Actions → Guest / Public → /`
...
| 2 | `crates/client/src/pages/home.rs` | `page component / re-export` | Dioxus Route selected page module | UI component |
