...
slug: /ui/guest-public/reset-password-token
hide_table_of_contents: true
---

# /reset-password?:token

**树路径：** `BurnCloud → UI-only Actions → Guest / Public → /reset-password?:token`
...
```text
navigate_to=/reset-password?:token
authenticated=true
locale=zh-CN
theme=system
```
...
| 2 | `crates/client/src/components/guest_layout.rs` | `layout/component` | Dioxus layout/component wrapper | UI state |
| 3 | `crates/client/src/pages/reset_password.rs` | `page component / re-export` | Dioxus Route selected page module | UI component |
