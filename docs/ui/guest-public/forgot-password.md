...
slug: /ui/guest-public/forgot-password
hide_table_of_contents: true
---

# /forgot-password

**树路径：** `BurnCloud → UI-only Actions → Guest / Public → /forgot-password`
...
| 3 | `crates/client/src/pages/forgot_password.rs` | `page component / re-export` | Dioxus Route selected page module | UI component |
