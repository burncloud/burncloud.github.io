---
title: "PR #484 — cleanup(interfaces): retire cache admin UI and routes"
slug: /pr/pr-484
---

# PR #484 — cleanup(interfaces): retire cache admin UI and routes

> **状态：** MERGED  
> **作者：** `rustburn`  
> **创建：** `2026-09-14T06:51:59Z`  
> **Base：** `main@1545eec83ed3`  
> **Head：** `cleanup/retire-cache-admin-interfaces-483@0b4ff0d3456e`  
...
- **Changed Files：** `6`
- **Additions / Deletions：** `+1 / -150`
- **受影响的完整 E2E Flow：** `49`
- **未映射 changed files：** `4`

**PR 说明摘要：** ## Summary Closes #483. Apply the retirement decision from #482 across both sides of the internal UI↔Server contract: - remove Server cache API module and route registration; - delete `GET /console/api/cache/stats` and `POST /console/api/cache/clear`; - remove Client request functions; - remove Settings cache statistics and maintenance UI; - remove obsolete functional-wiring requirements; - remove the old 401 test that could not distinguish a protected route from a removed route. ## Boundary This PR changes Interfaces only. It intentionally leaves `CacheService`, Server `AppState`, startup initialization, the Cache crate, and dependencies for the next Platform cleanup Issue. Changed/deleted only: - `crates/server/src/api/mod.rs` - `crates/server/src/api/cache.rs` (deleted) - `crates/server/tests/api_tests.rs` - `crates/client/src/functional_api.rs` - `crates/client/src/functional_pages/settings.rs` - `crates/client/scripts/check-functional-wiring.sh` Unchanged: - admin middleware and all other admin routes; - Environment and Runtime health Settings; - authentication, billing, routing, database, CacheService, Redis, and directory layout. ## Verification Completed: - `git diff --check main...HEAD`; - `bash crates/client/scripts/check-functional-wiring.sh` → `Functional console wiring OK`; - static search confirms no retired Cache path, Client function, Settings resource, or Serve…

## Changed Files

| 文件 | 状态 | + | - | Atlas 命中 |
|---|---:|---:|---:|---:|
| `crates/client/scripts/check-functional-wiring.sh` | modified | 0 | 3 | 0 |
| `crates/client/src/functional_api.rs` | modified | 0 | 12 | 0 |
| `crates/client/src/functional_pages/settings.rs` | modified | 1 | 71 | 0 |
| `crates/server/src/api/cache.rs` | removed | 0 | 33 | 4 |
| `crates/server/src/api/mod.rs` | modified | 0 | 2 | 49 |
| `crates/server/tests/api_tests.rs` | modified | 0 | 29 | 0 |

## Affected E2E Impact Matrix

| # | 完整 E2E / Entry Point | 类型 | PR 命中的源码文件 |
|---:|---|---|---|
| 1 | `POST /api/auth/register` | HTTP / API / Authentication | `crates/server/src/api/mod.rs` |
| 2 | `POST /api/auth/login` | HTTP / API / Authentication | `crates/server/src/api/mod.rs` |
| 3 | `POST /api/auth/forgot-password` | HTTP / API / Authentication | `crates/server/src/api/mod.rs` |
| 4 | `POST /api/auth/reset-password` | HTTP / API / Authentication | `crates/server/src/api/mod.rs` |
| 5 | `GET /api/auth/google` | HTTP / API / Authentication | `crates/server/src/api/mod.rs` |
| 6 | `GET /api/auth/github` | HTTP / API / Authentication | `crates/server/src/api/mod.rs` |
| 7 | `GET /console/api/channel` | HTTP / API / Channel Management | `crates/server/src/api/mod.rs` |
| 8 | `POST /console/api/channel` | HTTP / API / Channel Management | `crates/server/src/api/mod.rs` |
| 9 | `PUT /console/api/channel` | HTTP / API / Channel Management | `crates/server/src/api/mod.rs` |
| 10 | `GET /console/api/channel/{id}` | HTTP / API / Channel Management | `crates/server/src/api/mod.rs` |
| 11 | `DELETE /console/api/channel/{id}` | HTTP / API / Channel Management | `crates/server/src/api/mod.rs` |
| 12 | `GET /console/api/tokens` | HTTP / API / Token | `crates/server/src/api/mod.rs` |
| 13 | `POST /console/api/tokens` | HTTP / API / Token | `crates/server/src/api/mod.rs` |
| 14 | `GET /console/api/tokens/{token}` | HTTP / API / Token | `crates/server/src/api/mod.rs` |
| 15 | `PUT /console/api/tokens/{token}` | HTTP / API / Token | `crates/server/src/api/mod.rs` |
| 16 | `DELETE /console/api/tokens/{token}` | HTTP / API / Token | `crates/server/src/api/mod.rs` |
| 17 | `POST /console/api/tokens/{token}/rotate` | HTTP / API / Token | `crates/server/src/api/mod.rs` |
| 18 | `POST /console/api/tokens/{token}/revoke-old` | HTTP / API / Token | `crates/server/src/api/mod.rs` |
| 19 | `POST /console/api/tokens/{token}/ip-whitelist` | HTTP / API / Token | `crates/server/src/api/mod.rs` |
| 20 | `POST /console/api/user/register` | HTTP / API / User | `crates/server/src/api/mod.rs` |
| 21 | `POST /console/api/user/login` | HTTP / API / User | `crates/server/src/api/mod.rs` |
| 22 | `POST /console/api/user/topup` | HTTP / API / User | `crates/server/src/api/mod.rs` |
| 23 | `GET /console/api/user/check_username` | HTTP / API / User | `crates/server/src/api/mod.rs` |
| 24 | `GET /console/api/user/recharges` | HTTP / API / User | `crates/server/src/api/mod.rs` |
| 25 | `GET /console/api/list_users` | HTTP / API / User | `crates/server/src/api/mod.rs` |
| 26 | `GET /api/billing/summary` | HTTP / API / Billing / Usage | `crates/server/src/api/mod.rs` |
| 27 | `GET /console/api/logs` | HTTP / API / Logs | `crates/server/src/api/mod.rs` |
| 28 | `GET /console/api/usage/{user_id}` | HTTP / API / Logs | `crates/server/src/api/mod.rs` |
| 29 | `GET /console/internal/billing/summary` | HTTP / API / Billing / Usage | `crates/server/src/api/mod.rs` |
| 30 | `GET /console/api/monitor` | HTTP / API / Monitoring / Security | `crates/server/src/api/mod.rs` |
| 31 | `GET /console/api/monitor/security` | HTTP / API / Monitoring / Security | `crates/server/src/api/mod.rs` |
| 32 | `GET /console/api/monitor/security/events` | HTTP / API / Monitoring / Security | `crates/server/src/api/mod.rs` |
| 33 | `GET /console/api/monitor/security/filters` | HTTP / API / Monitoring / Security | `crates/server/src/api/mod.rs` |
| 34 | `PUT /console/api/monitor/security/filters` | HTTP / API / Monitoring / Security | `crates/server/src/api/mod.rs` |
| 35 | `POST /console/api/monitor/security/emergency-circuit-break` | HTTP / API / Monitoring / Security | `crates/server/src/api/mod.rs` |
| 36 | `GET /console/api/monitor/security/circuit-breaker-status` | HTTP / API / Monitoring / Security | `crates/server/src/api/mod.rs` |
| 37 | `GET /console/api/cache/stats` | HTTP / API / Cache | `crates/server/src/api/mod.rs`&lt;br/&gt;`crates/server/src/api/cache.rs` |
| 38 | `POST /console/api/cache/clear` | HTTP / API / Cache | `crates/server/src/api/mod.rs`&lt;br/&gt;`crates/server/src/api/cache.rs` |
| 39 | `GET /console/api/usage/{user_id}` | HTTP / API / Billing / Usage | `crates/server/src/api/mod.rs` |
| 40 | `GET /console/api/{*path} → protected 404 catch-all` | HTTP / API / Admin / Internal | `crates/server/src/api/mod.rs` |
| 41 | `GET /api-docs/openapi.json` | HTTP / API / OpenAPI / Swagger | `crates/server/src/api/mod.rs` |
| 42 | `GET /swagger-ui` | HTTP / API / OpenAPI / Swagger | `crates/server/src/api/mod.rs` |
| 43 | `GET /swagger-ui/` | HTTP / API / OpenAPI / Swagger | `crates/server/src/api/mod.rs` |
| 44 | `server` | CLI / Executables / burncloud | `crates/server/src/api/mod.rs`&lt;br/&gt;`crates/server/src/api/cache.rs` |
| 45 | `router` | CLI / Executables / burncloud | `crates/server/src/api/mod.rs`&lt;br/&gt;`crates/server/src/api/cache.rs` |
| 46 | `System Monitor Auto Update` | Background Jobs / Async Side Effects / Long-running Jobs | `crates/server/src/api/mod.rs` |
| 47 | `start_server` | Startup / Startup Chain | `crates/server/src/api/mod.rs` |
| 48 | `create_app` | Startup / Startup Chain | `crates/server/src/api/mod.rs` |
| 49 | `Windows Background Server Thread` | Background Jobs / Async Side Effects / Desktop Background Work | `crates/server/src/api/mod.rs` |

## 完整受影响 E2E Request Flow

### E2E FLOW #1 — POST /api/auth/register
...
### E2E FLOW #2 — POST /api/auth/login
...
### E2E FLOW #3 — POST /api/auth/forgot-password
...
### E2E FLOW #4 — POST /api/auth/reset-password
...
### E2E FLOW #5 — GET /api/auth/google
...
### E2E FLOW #6 — GET /api/auth/github
...
### E2E FLOW #7 — GET /console/api/channel
...
### E2E FLOW #8 — POST /console/api/channel
...
### E2E FLOW #9 — PUT /console/api/channel
...
### E2E FLOW #10 — GET /console/api/channel/&#123;id&#125;
...
### E2E FLOW #11 — DELETE /console/api/channel/&#123;id&#125;
...
### E2E FLOW #12 — GET /console/api/tokens
...
### E2E FLOW #13 — POST /console/api/tokens
...
### E2E FLOW #14 — GET /console/api/tokens/&#123;token&#125;
...
### E2E FLOW #15 — PUT /console/api/tokens/&#123;token&#125;
...
### E2E FLOW #16 — DELETE /console/api/tokens/&#123;token&#125;
...
### E2E FLOW #17 — POST /console/api/tokens/&#123;token&#125;/rotate
...
### E2E FLOW #18 — POST /console/api/tokens/&#123;token&#125;/revoke-old
...
### E2E FLOW #19 — POST /console/api/tokens/&#123;token&#125;/ip-whitelist
...
### E2E FLOW #20 — POST /console/api/user/register
...
### E2E FLOW #21 — POST /console/api/user/login
...
### E2E FLOW #22 — POST /console/api/user/topup
...
### E2E FLOW #23 — GET /console/api/user/check_username
...
### E2E FLOW #24 — GET /console/api/user/recharges
...
### E2E FLOW #25 — GET /console/api/list_users
...
### E2E FLOW #26 — GET /api/billing/summary
...
### E2E FLOW #27 — GET /console/api/logs
...
### E2E FLOW #28 — GET /console/api/usage/&#123;user_id&#125;
...
### E2E FLOW #29 — GET /console/internal/billing/summary
...
### E2E FLOW #30 — GET /console/api/monitor
...
### E2E FLOW #31 — GET /console/api/monitor/security
...
### E2E FLOW #32 — GET /console/api/monitor/security/events
...
### E2E FLOW #33 — GET /console/api/monitor/security/filters
...
### E2E FLOW #34 — PUT /console/api/monitor/security/filters
...
### E2E FLOW #35 — POST /console/api/monitor/security/emergency-circuit-break
...
### E2E FLOW #36 — GET /console/api/monitor/security/circuit-breaker-status
...
### E2E FLOW #37 — GET /console/api/cache/stats

**树路径：** `HTTP / API → Cache → GET /console/api/cache/stats`  
**PR Impact：** `STATIC SOURCE-PATH MATCH`  
**本 Flow 命中的 changed files：** `crates/server/src/api/mod.rs`, `crates/server/src/api/cache.rs`
...
│
▼
FILE: crates/server/src/api/cache.rs  [PR CHANGED]
│
├─ Handler
│    └─ stats()
│
...
### E2E FLOW #38 — POST /console/api/cache/clear
...
### E2E FLOW #39 — GET /console/api/usage/&#123;user_id&#125;
...
### E2E FLOW #40 — GET /console/api/&#123;*path&#125; → protected 404 catch-all
...
### E2E FLOW #41 — GET /api-docs/openapi.json
...
### E2E FLOW #46 — System Monitor Auto Update
...
### E2E FLOW #49 — Windows Background Server Thread
