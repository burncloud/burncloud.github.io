---
title: "burncloud currency list-rates"
slug: /cli/burncloud/currency/list-rates
hide_table_of_contents: true
---

# burncloud currency list-rates

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud currency list-rates`
...
│    ├─ command: burncloud currency list-rates
