---
title: "burncloud currency set-rate"
slug: /cli/burncloud/currency/set-rate
hide_table_of_contents: true
---

# burncloud currency set-rate

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud currency set-rate`
...
│    ├─ command: burncloud currency set-rate
