---
title: "burncloud currency convert <amount>"
slug: /cli/burncloud/currency/convert-amount
hide_table_of_contents: true
---

# burncloud currency convert &lt;amount&gt;

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud currency convert <amount>`

> **中文解释：** Clap 解析到 currency 分支，再进入 src/cli/currency.rs 中对应命令实现；参数校验失败时由 Clap/命令逻辑提前结束。
>
...
│    ├─ command: burncloud currency convert <amount>
