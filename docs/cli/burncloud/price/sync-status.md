---
title: "burncloud price sync-status"
slug: /cli/burncloud/price/sync-status
hide_table_of_contents: true
---

# burncloud price sync-status

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud price sync-status`
...
│
├─ Shell input
│    ├─ command: burncloud price sync-status
