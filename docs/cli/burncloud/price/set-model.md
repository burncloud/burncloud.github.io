---
title: "burncloud price set <model>"
slug: /cli/burncloud/price/set-model
hide_table_of_contents: true
---

# burncloud price set &lt;model&gt;

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud price set <model>`
...
│
├─ Shell input
│    ├─ command: burncloud price set <model>
