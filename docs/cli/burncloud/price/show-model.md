---
title: "burncloud price show <model>"
slug: /cli/burncloud/price/show-model
hide_table_of_contents: true
---

# burncloud price show &lt;model&gt;

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud price show <model>`
...
│
├─ Shell input
│    ├─ command: burncloud price show <model>
