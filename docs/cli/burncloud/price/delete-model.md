---
title: "burncloud price delete <model>"
slug: /cli/burncloud/price/delete-model
hide_table_of_contents: true
---

# burncloud price delete &lt;model&gt;

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud price delete <model>`
...
│
├─ Shell input
│    ├─ command: burncloud price delete <model>
