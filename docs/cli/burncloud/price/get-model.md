---
title: "burncloud price get <model>"
slug: /cli/burncloud/price/get-model
hide_table_of_contents: true
---

# burncloud price get &lt;model&gt;

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud price get <model>`
...
│
├─ Shell input
│    ├─ command: burncloud price get <model>
