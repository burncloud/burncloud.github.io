---
title: "burncloud price export <file>"
slug: /cli/burncloud/price/export-file
hide_table_of_contents: true
---

# burncloud price export &lt;file&gt;

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud price export <file>`
...
│
├─ Shell input
│    ├─ command: burncloud price export <file>
