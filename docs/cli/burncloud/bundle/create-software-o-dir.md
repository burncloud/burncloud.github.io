---
title: "burncloud bundle create <software> -o DIR"
slug: /cli/burncloud/bundle/create-software-o-dir
hide_table_of_contents: true
---

# burncloud bundle create &lt;software&gt; -o DIR

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud bundle create <software> -o DIR`

> **中文解释：** Clap 解析到 bundle 分支，再进入 src/cli/bundle.rs 中对应命令实现；参数校验失败时由 Clap/命令逻辑提前结束。
>
...
| 3 | `src/cli/bundle.rs` | `entry-specific function(s) shown in E2E` | 当前入口在该文件执行的直接调用点 | runtime-specific |
