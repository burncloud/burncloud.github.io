---
title: "burncloud token create"
slug: /cli/burncloud/token/create
hide_table_of_contents: true
---

# burncloud token create

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud token create`
...
│
├─ Shell input
│    ├─ command: burncloud token create
