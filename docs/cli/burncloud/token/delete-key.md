---
title: "burncloud token delete <key>"
slug: /cli/burncloud/token/delete-key
hide_table_of_contents: true
---

# burncloud token delete &lt;key&gt;

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud token delete <key>`
...
│
├─ Shell input
│    ├─ command: burncloud token delete <key>
