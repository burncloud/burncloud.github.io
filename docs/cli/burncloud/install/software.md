---
title: "burncloud install [software]"
slug: /cli/burncloud/install/software
hide_table_of_contents: true
---

# burncloud install [software]

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud install [software]`
...
│
├─ Shell input
│    ├─ command: burncloud install [software]
