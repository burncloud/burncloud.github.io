---
title: "burncloud install --auto-deps"
slug: /cli/burncloud/install/auto-deps
hide_table_of_contents: true
---

# burncloud install --auto-deps

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud install --auto-deps`
...
│
├─ Shell input
│    ├─ command: burncloud install --auto-deps
