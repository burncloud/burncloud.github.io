---
title: "burncloud install --bundle DIR"
slug: /cli/burncloud/install/bundle-dir
hide_table_of_contents: true
---

# burncloud install --bundle DIR

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud install --bundle DIR`
...
│
├─ Shell input
│    ├─ command: burncloud install --bundle DIR
...
| 3 | `src/cli/install.rs` | `见上方 E2E 对应函数/入口` | 该 CLI/UI/Background/Startup 页面真实执行文件 | runtime-specific |
