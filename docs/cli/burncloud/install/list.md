---
title: "burncloud install --list"
slug: /cli/burncloud/install/list
hide_table_of_contents: true
---

# burncloud install --list

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud install --list`
...
│
├─ Shell input
│    ├─ command: burncloud install --list
