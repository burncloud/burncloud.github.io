---
title: "burncloud install --status"
slug: /cli/burncloud/install/status
hide_table_of_contents: true
---

# burncloud install --status

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud install --status`
...
│
├─ Shell input
│    ├─ command: burncloud install --status
