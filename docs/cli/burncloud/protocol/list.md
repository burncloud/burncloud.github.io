---
title: "burncloud protocol list"
slug: /cli/burncloud/protocol/list
hide_table_of_contents: true
---

# burncloud protocol list

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud protocol list`
...
│
├─ Shell input
│    ├─ command: burncloud protocol list
