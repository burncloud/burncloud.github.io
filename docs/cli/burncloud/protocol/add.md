---
title: "burncloud protocol add"
slug: /cli/burncloud/protocol/add
hide_table_of_contents: true
---

# burncloud protocol add

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud protocol add`
...
│
├─ Shell input
│    ├─ command: burncloud protocol add
