---
title: "burncloud tiered delete-tiers <model>"
slug: /cli/burncloud/tiered/delete-tiers-model
hide_table_of_contents: true
---

# burncloud tiered delete-tiers &lt;model&gt;

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud tiered delete-tiers <model>`
...
│
├─ Shell input
│    ├─ command: burncloud tiered delete-tiers <model>
