---
title: "burncloud tiered check-tiered <model>"
slug: /cli/burncloud/tiered/check-tiered-model
hide_table_of_contents: true
---

# burncloud tiered check-tiered &lt;model&gt;

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud tiered check-tiered <model>`
...
│
├─ Shell input
│    ├─ command: burncloud tiered check-tiered <model>
