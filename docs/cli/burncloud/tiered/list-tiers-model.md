---
title: "burncloud tiered list-tiers <model>"
slug: /cli/burncloud/tiered/list-tiers-model
hide_table_of_contents: true
---

# burncloud tiered list-tiers &lt;model&gt;

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud tiered list-tiers <model>`
...
│
├─ Shell input
│    ├─ command: burncloud tiered list-tiers <model>
