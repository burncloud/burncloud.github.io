---
title: "burncloud channel show <id>"
slug: /cli/burncloud/channel/show-id
hide_table_of_contents: true
---

# burncloud channel show &lt;id&gt;

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud channel show <id>`
...
│    ├─ command: burncloud channel show <id>
