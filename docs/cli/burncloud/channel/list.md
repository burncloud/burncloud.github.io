---
title: "burncloud channel list"
slug: /cli/burncloud/channel/list
hide_table_of_contents: true
---

# burncloud channel list

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud channel list`
...
│    ├─ command: burncloud channel list
