---
title: "burncloud channel update <id>"
slug: /cli/burncloud/channel/update-id
hide_table_of_contents: true
---

# burncloud channel update &lt;id&gt;

**树路径：** `BurnCloud → CLI / Executables → burncloud → burncloud channel update <id>`
...
│    ├─ command: burncloud channel update <id>
