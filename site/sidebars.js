  ...
  docsSidebar: [
    {type:'category', label:'BurnCloud', collapsed:false, link:{type:'doc', id:'index'}, items:[
      ...
      {type:'category', label:'BurnCloud 界面', collapsed:true, link:{type:'doc', id:'burncloud-ui/index'}, items:[
        ...
        {type:'category', label:'Buyer', collapsed:true, link:{type:'doc', id:'burncloud-ui/buyer/index'}, items:[
          ...
          {type:'doc', id:'burncloud-ui/buyer/logs', label:'日志'},
        ]},
    ...
    {type:'category', label:'技术参考', collapsed:true, items:[
      ...
      {type:'category', label:"PR 变更图谱（最近 50 条）", collapsed:true, items:[
        {type:'doc', id:"pr/pr-563", label:"#563 feat(node): close live request lifecycle gaps"},
        {type:'doc', id:"pr/pr-562", label:"#562 feat: add bundle.rs"},
        {type:'doc', id:"pr/pr-561", label:"#561 fix(client): support Dioxus 0.7.5 icon API"},
        {type:'doc', id:"pr/pr-560", label:"#560 feat(traffic): define local route preference contract"},
        {type:'doc', id:"pr/pr-559", label:"#559 feat(traffic): define local route preference contract"},
        {type:'doc', id:"pr/pr-558", label:"#558 refactor(node): keep route preference owned by Traffic"},
        {type:'doc', id:"pr/pr-557", label:"#557 feat(node): define MODEL_PREPARING request contract"},
        {type:'doc', id:"pr/pr-556", label:"#556 feat(node): compose ready runtime with existing router attachment"},
        {type:'doc', id:"pr/pr-555", label:"#555 feat(node): settle unsupported local demand"},
        {type:'doc', id:"pr/pr-554", label:"#554 feat(node): define runtime-owned process plan contract"},
        {type:'doc', id:"pr/pr-553", label:"#553 feat(client): add interactive buyer playground and desktop chrome po..."},
        {type:'doc', id:"pr/pr-552", label:"#552 fix(node): disambiguate failed reconcile transition"},
        {type:'doc', id:"pr/pr-551", label:"#551 feat(node): skip local work when machine cannot run model"},
        {type:'doc', id:"pr/pr-550", label:"#550 chore(router): clean up compiler warnings"},
        {type:'doc', id:"pr/pr-549", label:"#549 fix(cli): initialize required runtime secrets"},
        {type:'doc', id:"pr/pr-548", label:"#548 test(node): prove framework-owned fake lifecycle"},
        {type:'doc', id:"pr/pr-547", label:"#547 feat(node): gate recovery on unhealthy route detachment"},
        {type:'doc', id:"pr/pr-546", label:"#546 feat(node): dispatch reconcile actions through owner ports"},
        {type:'doc', id:"pr/pr-545", label:"#545 feat(node): define desired model demand input"},
        {type:'doc', id:"pr/pr-544", label:"#544 feat(node): add application-level orchestration root"},
        {type:'doc', id:"pr/pr-543", label:"#543 feat(node): complete machine capability composition root"},
        {type:'doc', id:"pr/pr-542", label:"#542 test(node): close fake golden path with supply resolver"},
        {type:'doc', id:"pr/pr-541", label:"#541 feat(supply): add model resolver contract and fake"},
        {type:'doc', id:"pr/pr-540", label:"#540 test(node): wire fake preparation capabilities into golden path"},
        {type:'doc', id:"pr/pr-539", label:"#539 feat(node): add missing fakeable preparation capability ports"},
        {type:'doc', id:"pr/pr-538", label:"#538 test(node): complete Phase-0 existing-router acceptance"},
        {type:'doc', id:"pr/pr-537", label:"#537 fix(node): make runtime invariant crate documentation"},
        {type:'doc', id:"pr/pr-536", label:"#536 feat(router): identify Node route attachments by channel id"},
        {type:'doc', id:"pr/pr-535", label:"#535 feat(router): attach ready Node endpoints to existing routing truth"},
        {type:'doc', id:"pr/pr-534", label:"#534 feat(router): define Node local attachment boundary"},
        {type:'doc', id:"pr/pr-533", label:"#533 test(node): prove phase-0 fake golden path"},
        {type:'doc', id:"pr/pr-532", label:"#532 feat(node): add machine-level composition root"},
        {type:'doc', id:"pr/pr-531", label:"#531 feat(node): add demand reconciler skeleton"},
        {type:'doc', id:"pr/pr-530", label:"#530 feat(node): define runtime convergence state model"},
        {type:'doc', id:"pr/pr-529", label:"#529 feat(node): add reusable fake platform capabilities"},
        {type:'doc', id:"pr/pr-528", label:"#528 feat(node): define machine-level capability contracts"},
        {type:'doc', id:"pr/pr-524", label:"#524 feat(node): add minimal Node runtime skeleton"},
        {type:'doc', id:"pr/pr-523", label:"#523 feat(client): replace Dioxus client with burncloud-web UI"},
        {type:'doc', id:"pr/pr-522", label:"#522 refactor: migrate crates into domain directories"},
        {type:'doc', id:"pr/pr-521", label:"#521 security(installer): validate npm mirror arguments"},
        {type:'doc', id:"pr/pr-519", label:"#519 cleanup(observability): retire unwired metrics module"},
        {type:'doc', id:"pr/pr-515", label:"#515 cleanup(observability): retire unused alert crate"},
        {type:'doc', id:"pr/pr-499", label:"#499 docs(config): correct fresh database safety guidance"},
        {type:'doc', id:"pr/pr-495", label:"#495 security(internal): inject one validated secret source"},
        {type:'doc', id:"pr/pr-493", label:"#493 security(jwt): require one injected secret source"},
        {type:'doc', id:"pr/pr-489", label:"#489 cleanup(docs): remove shared agent context"},
        {type:'doc', id:"pr/pr-488", label:"#488 test(ui): remove retired cache admin contracts"},
        {type:'doc', id:"pr/pr-486", label:"#486 cleanup(cache): remove empty cache subsystem"},
        {type:'doc', id:"pr/pr-484", label:"#484 cleanup(interfaces): retire cache admin UI and routes"},
        {type:'doc', id:"pr/pr-481", label:"#481 cleanup(cache): remove unused error variants"},
      ]},
