  ...
  docsSidebar: [
    ...
    {type:'category', label:'技术参考', collapsed:true, items:[
      ...
      {type:'category', label:"PR 变更图谱（最近 50 条）", collapsed:true, items:[
        ...
        {type:'doc', id:"pr/pr-479", label:"#479 cleanup(cache): remove unused direct dependencies"},
        {type:'doc', id:"pr/pr-477", label:"#477 cleanup(cache): remove unused price cache API"},
        {type:'doc', id:"pr/pr-475", label:"#475 cleanup(cache): remove unused quota cache API"},
        {type:'doc', id:"pr/pr-473", label:"#473 cleanup(cache): remove unused token cache API"},
        {type:'doc', id:"pr/pr-471", label:"#471 cleanup(cache): remove unused channel cache API"},
        {type:'doc', id:"pr/pr-469", label:"#469 security(cache): redact Redis credentials from logs and errors"},
